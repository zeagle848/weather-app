import { loadWeatherForecast } from '../src/utils/loadWeatherForecast';
import { locationService } from '../src/services/fetchLocation';

jest.mock('../src/services/fetchForecast', () => ({
...
test('Can use data returned from OpenWeatherAPI for getting seven day forecast', async () => {
  jest
  ...
  expect(
    await loadWeatherForecast({ location: 'Cape Town', units: 'metric' })
  ).toEqual([
    {
      day: 'Friday',
      avgTemp: 23,
